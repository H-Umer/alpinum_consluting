...
const Page = () => {
  ...
  const contractorId = decodeURIComponent(params.id);
  ...
  const fetchContractor = async () => {
    ...
    try {
      const response = await fetch(
        `/api/company/contractor-profile/${contractorId}?resumeProfile=${resumeProfile}`,
        {
          method: "GET",
          headers: {
